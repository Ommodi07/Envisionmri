    ...
    <>
      <div className="w-[550px] gap-3 flex flex-col items-start px-[70px] py-[100px]">
        ...
        <form
          ...
          className="relative flex flex-col gap-5 items-start w-full"
        >
          {isSignup && (
            <>
              ...
              <div className="flex flex-col gap-1 items-start self-stretch max-w-xs">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`border-2 border-solid ${
                    errors.lastname ? "border-red-500" : "hover:border-blue-600"
                  } focus:border-2 focus:border-blue-600 outline-none rounded-md items-center px-6 py-2 text-sm h-9 w-full transition-colors`}
                />
                {errors.lastname && (
                  <span className="text-red-500 text-xs mt-1">
              ...
              <div className="flex flex-col gap-1 items-start self-stretch max-w-xs">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`border-2 border-solid ${
                    errors.password ? "border-red-500" : "hover:border-blue-600"
                  } focus:border-2 focus:border-blue-600 outline-none rounded-md items-center px-6 py-2 text-sm h-9 w-full transition-colors`}
                />
          ...
          <div className="flex flex-col gap-1 items-start self-stretch max-w-xs">
            ...
            <input
              ...
              onChange={handleChange}
              className={`border-2 border-solid ${
                errors.email ? "border-red-500" : "hover:border-blue-600"
              } focus:border-2 focus:border-blue-600 outline-none rounded-md items-center px-6 py-2 text-sm h-9 w-full transition-colors`}
            />
            {errors.email && (
